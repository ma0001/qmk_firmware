...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(
        ...
        KC_LSFT, _______, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RSFT, KC_RSFT, MO(1),
        KC_LCTL, KC_LALT, KC_LALT, KC_LGUI, KC_LGUI, KC_SPC,                    KC_SPC,  KC_SPC,  KC_RGUI, KC_LEFT, KC_UP,   KC_DOWN, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT_all(
